defmodule Hack18.Net.Client do
  @moduledoc """
  Hack18 peer client
  """
  ...
  Example:
      ...
      {:ok, client} = Hack18.Net.Client.connect("localhost", 3418)
      Hack18.Net.Client.send_state(client, %{"anything" => "here"})
      Socket.Stream.recv(client.socket)
      Hack18.Net.Client.disconnect(client)
